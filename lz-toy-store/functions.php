...
function lz_toy_store_scripts() {
	...
	wp_enqueue_script( 'lz-toy-store-skip-link-focus-fix', get_theme_file_uri( '/assets/js/skip-link-focus-fix.js' ), array(), '1.0', true );

	$lz_toy_store_l10n=array();
	
	if ( has_nav_menu( 'top' ) ) {
		wp_enqueue_script( 'lz-toy-store-navigation-jquery', get_theme_file_uri( '/assets/js/navigation.js' ), array( 'jquery' ), '1.0', true );
		$lz_toy_store_l10n['expand']         = __( 'Expand child menu', 'lz-toy-store' );
		$lz_toy_store_l10n['collapse']       = __( 'Collapse child menu', 'lz-toy-store' );		
	}
	...
	wp_localize_script( 'lz-toy-store-skip-link-focus-fix', 'lz_toy_storeScreenReaderText', $lz_toy_store_l10n );
...
//footer Link
define('LZ_TOY_STORE_LIVE_DEMO',__('https://luzuk.com/demo/lz-toy-store/','lz-toy-store'));
define('LZ_TOY_STORE_PRO_DOCS',__('https://luzuk.com/demo/lz-toy-store/documentation/','lz-toy-store'));
define('LZ_TOY_STORE_BUY_NOW',__('https://www.luzuk.com/themes/toy-store-wordpress-theme/','lz-toy-store'));
